...
public class ViewOffsetHeaderBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    private ViewOffsetHelper mViewOffsetHelper;
    private int mTempTopBottomOffset = 0;

    public ViewOffsetHeaderBehavior() {
    }

    public ViewOffsetHeaderBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
